...
namespace CSharpTest
{
    ...
    public class WorkDayCalculatorTests
    {
        ...
        [TestMethod]
        public void TestWeekEndBeforeBeginning()
        {
            DateTime startDate = new DateTime(2021, 3, 10);
            int count = 5;
            WeekEnd[] weekends = new WeekEnd[2]
            {
                new WeekEnd(new DateTime(2021, 3, 5), new DateTime(2021, 3, 7)),
                new WeekEnd(new DateTime(2021, 3, 12), new DateTime(2021, 3, 13))
            };

            DateTime result = new WorkDayCalculator().Calculate(startDate, count, weekends);

            Assert.IsTrue(result.Equals(new DateTime(2021, 3, 16)));
        }
